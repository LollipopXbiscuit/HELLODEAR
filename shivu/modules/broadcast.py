...
async def broadcast(update: Update, context: CallbackContext) -> None:
    ...
    await update.message.reply_text(f"<tg-emoji emoji-id='5103087490349139576'>✅</tg-emoji> Broadcast complete!\n\n<tg-emoji emoji-id='5102733670943295663'>📤</tg-emoji> Sent to: {success_sends} chats/users\n<tg-emoji emoji-id='5102962128843704400'>❌</tg-emoji> Failed: {failed_sends}",
                parse_mode='HTML')
